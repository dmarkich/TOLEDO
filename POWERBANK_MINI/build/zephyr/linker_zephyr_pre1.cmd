...
MEMORY
    {
    FLASH (rx) : ORIGIN = 0x0, LENGTH = 0xf8000
 ...
 *(.ARM.exidx* gnu.linkonce.armexidx.*)
 ...
 bt_mesh_subnet_cb_area : SUBALIGN(4) { _bt_mesh_subnet_cb_list_start = .; KEEP(*(SORT_BY_NAME(._bt_mesh_subnet_cb.static.*))); _bt_mesh_subnet_cb_list_end = .; } > FLASH
 bt_mesh_app_key_cb_area : SUBALIGN(4) { _bt_mesh_app_key_cb_list_start = .; KEEP(*(SORT_BY_NAME(._bt_mesh_app_key_cb.static.*))); _bt_mesh_app_key_cb_list_end = .; } > FLASH
 ...
 *(".kernel.*")
 ...
 bt_mesh_ext_adv_area : ALIGN_WITH_INPUT SUBALIGN(4) { _bt_mesh_ext_adv_list_start = .; KEEP(*(SORT_BY_NAME(._bt_mesh_ext_adv.static.*))); _bt_mesh_ext_adv_list_end = .; } > SRAM AT > FLASH
...
bt_mesh_scene_entries_sections : ALIGN_WITH_INPUT SUBALIGN(4)
{
 *(SORT_BY_NAME("._bt_mesh_scene_entry.static.*"));
} > FLASH
bt_mesh_sensor_types_sections : ALIGN_WITH_INPUT SUBALIGN(4)
{
